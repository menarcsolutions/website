...
import { SEO_SERVICES } from "@/lib/seo-config";
...
export async function generateStaticParams() {
  return SEO_SERVICES.map((s) => ({ slug: s.slug }));
}
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const description = `Premium ${service.title.toLowerCase()} by Menarc Solutions. We engineer high-performance, cinematic digital platforms and business systems with 60FPS rendering and 100/100 Core Web Vitals.`;
    ...
    <div className="pt-24 pb-16 bg-white text-[#1d1d1f] select-none relative overflow-hidden">
      ...
      <section className="container-custom py-16 md:py-24 relative z-20">
        <div className="max-w-4xl mx-auto text-center">
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-[#f5f5f7] border border-[#d2d2d7]/60 mb-6 shadow-md">
            ...
            <span className="text-xs font-semibold uppercase tracking-wider text-[#86868b]">Premium Web Architecture</span>
          </div>

          <h1 className="text-5xl md:text-7xl lg:text-8xl font-black tracking-tighter mb-8 leading-[1.08]">
            <span className="block text-[#1d1d1f] mb-2">Bespoke Architecture</span>
          ...
          <p className="text-lg md:text-xl text-[#86868b] leading-relaxed mb-12 max-w-3xl mx-auto tracking-tight font-normal">
            We deliver uncompromising engineering quality for your {service.title.toLowerCase()} requirements. Combining cinematic UI/UX aesthetics with ultra-fast Next.js server-side performance.
          </p>
      ...
      <section className="container-custom py-20 border-b border-[#d2d2d7]/60 relative z-20">
        <div className="max-w-3xl mx-auto text-center mb-16">
          ...
          <p className="text-[#86868b] text-sm tracking-tight">We reject bloated legacy templates. Every platform is built from the ground up to achieve Silicon Valley engineering standards.</p>
        </div>
          ...
          {[
            {
              ...
              desc: "Ultra-smooth cinematic transitions and zero layout shifts ensure your users stay engaged and convert at higher rates.",
            },
            {
              icon: <Shield className="w-8 h-8 text-[#1d1d1f]" />,
              title: "Bulletproof Security & Compliance",
              desc: "Strict Content-Security-Policies, secure JWT authentication, and automated threat mitigation protect your enterprise assets.",
            },
            {
            ...
            },
            {
              ...
              title: "Tailored Fixed-Scope Pricing",
